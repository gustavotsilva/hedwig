    ...
    render(){
        return (
            <div className="container content mt-5 pt-3">
                <div className="row">
                    <h1>Your small piece of <span className="font-blue">magic</span> every <span className="font-blue">day</span></h1>
                </div>
                <div className="row mt-3 mt-lg-4 mb-4 mb-lg-4 pb-2 pb-lg-3">
                    <p>1 remarkable quote and 3 amazing illustrations by SMS</p>
                </div>
